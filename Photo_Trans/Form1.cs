...
namespace Photo_Trans
{
    public partial class Form1 : Form
    {
        ...
        {
            IMG_From = new Bitmap(@"C:\Users\Alp Eren\Desktop\Photo\1.2.png");
            pictureBox1.Image = IMG_From;
        }

        private void button5_Click(object sender, EventArgs e)
        {
            IMG_To = new Bitmap(@"C:\Users\Alp Eren\Desktop\Photo\2.3.jpg");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < pictureBox1.Image.Width; x++)
                for (int y = 0; y < pictureBox1.Image.Height; y++)
                {
                    ...
                    timer1.Enabled = true;
            //will be calculated according to trackbar
        }
